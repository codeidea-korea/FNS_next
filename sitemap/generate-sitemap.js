...
// 사이트 URL 설정
const baseUrl = "https://fns-renew.codeidea.io";
...
async function getUrlsAPI() {
  const response = await axios.get(
    "https://api.fashionandstyle.com/api/v1/sitemap/list",
    {
      headers: {
        "system-key":
          "23009A6381E37EE7F041E0FE5483D33652201022A00D14AC3A454F6665548142",
      },
    },
  );
