...
const LandingLayout = ({ children }) => {
  ...
  useEffect(() => {
    lottie.loadAnimation({
      ...
      loop: false,
      autoplay: true,
      path: "/json/_logo.json",
    });

    const animbg = lottie.loadAnimation({
      container: document.querySelector("#lottiebg"),
      renderer: "svg",
      loop: false,
      autoplay: false,
      path: "/json/circldbg-pc.json",
    });

    const animbgmo = lottie.loadAnimation({
      container: document.querySelector("#lottiebgmo"),
      renderer: "svg",
      loop: false,
      autoplay: false,
      path: "/json/_circlebg_mob.json",
    });

    const handleScroll = () => {
      const winT = window.scrollY;
      if (winT > 0) {
        document.querySelector(".about_intro").classList.add("off", "bgtrans");
        document.querySelector(".scroll_more").classList.add("off");
        animbg.play();
        animbgmo.play();
      } else {
        document.querySelector(".scroll_more").classList.remove("off");
        animbg.goToAndPlay(0, true);
        animbgmo.goToAndPlay(0, true);
      }
    };
    ...
    <>
      <div id="wrap">
        <div id="landing">
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="https://story.kakao.com/ch/fashionstyle"
                        target="_blank"
                      >
                        카카오스토리
                      </a>
          ...
          >
            <div id="lottiebgmo" className="mo_ver"></div>
          </div>

          <div className="content sub">{children}</div>
