...
const Detail = () => {
  ...
  const scrollHandle = () => {
    ...
    if (
      window.scrollY >
      top.offsetTop + top.clientHeight - btCategory.clientHeight * 2.5
    ) {
  ...
  const cateClick = (e) => {
    ...
    const targetTop =
      document.querySelector(`.category_cont[data-cont="${target}"]`)
        .offsetTop - 129;
  ...
  const categoryPosition = (target) => {
    ...
    const changePosition =
      -targetPosition + swiper.clientWidth / 2 - targetSize / 2; // 타겟 화면 정중앙에 놓기
      ...
      <div className="bottom_category">
        ...
        <div className="cate_wrap">
          ...
          >
            <SwiperSlide
              className="active"
              data-target="category_01"
              onClick={cateClick}
            >
              <span>BEST 5</span>
            </SwiperSlide>
            <SwiperSlide onClick={cateClick} data-target="category_02">
              <span>아이템활용법</span>
            </SwiperSlide>
            <SwiperSlide onClick={cateClick} data-target="category_03">
              <span>브랜드필수템</span>
            </SwiperSlide>
            <SwiperSlide onClick={cateClick} data-target="category_04">
              <span>시즌코디</span>
            </SwiperSlide>
            <SwiperSlide onClick={cateClick} data-target="category_05">
              <span>아이템조합</span>
            </SwiperSlide>
            <SwiperSlide onClick={cateClick} data-target="category_06">
              <span>여행</span>
            </SwiperSlide>
            <SwiperSlide onClick={cateClick} data-target="category_07">
              <span>헤어트렌드</span>
            </SwiperSlide>
          </Swiper>
        </div>
