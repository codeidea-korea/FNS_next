    ...
    <section className="post_frame">
      ...
      >
        {data.video && (
          <SwiperSlide key="video" className="video_item">
            ...
            <video
              poster="/img/thumbnail/video_1.png"
              autoPlay
              muted
              loop
              playsInline
        ...
        {data.img_id.length == 1 ? (
          <div className="tag_list">
            <span className="active" onClick={clickModalEvent} id="source">
              instagram @{data.img_id}
            </span>
          </div>
        ) : (
          <div className="tag_list">
            {data.img_id.map((item, index) => (
              <span
                ...
                data-modal-id="source-modal"
                onClick={clickModalEvent}
              >
                instagram @{item}
              </span>
            ))}
        ...
        <div className="pager">
          {swiperActive + 1} /{" "}
          {data.img.length + (data.video ? data.video.length : 0)}
        </div>
      </Swiper>
      ...
      <div className="txt_box">
        ...
        <div className="desc_box" onClick={descHandle}>
          <div className={descOpen ? "desc open" : "desc"}>
            {desc.map((item, index) => (
              <p key={index}>
                {item}
                {desc.length > 2 && index == 1 && <button>...더 보기</button>}
              </p>
            ))}
          </div>
        </div>
        ...
        <div className="comment_list">
          <p onClick={clickModalEvent} id="appDownload">
            댓글 16개 모두 보기
          </p>
          ...
          <div className="modal_box">
            ...
            <div className="modal_content">
              <div className="insta_item">
                ...
                <Link>
                  <i>
                    <img src="/img/insta_jennie.jpg" alt="" />
                  </i>
                  <div>
                    <b>제니</b>
                ...
                <Link>
                  <i className="insta_icon">
                    <img src="/img/insta_icon.svg" alt="" />
                  </i>
                  <div>
