        ...
        <div className="title">
          <a style={{ cursor: "pointer" }} onClick={openAppDownModalFn}>
            <i>
              <img
                src={
                  grpItem?.itm_data[0]?.tag_type_cd === "TAG002005"
                    ? grpItem?.itm_data[0].image_url_def
                    : grpItem?.itm_data[0].image_url1
                }
                alt={grpItem.itm_name}
              />
            </i>
          ...
          <li key={index}>
            <a style={{ cursor: "pointer" }} onClick={openAppDownModalFn}>
              <div className="img_box">
                <img
                  src={
                    item?.tag_type_cd === "TAG002005"
                      ? item.image_url_def
                      : item.image_url1
                  }
                  alt={item.tag_name + " 이미지"}
                />
              </div>
